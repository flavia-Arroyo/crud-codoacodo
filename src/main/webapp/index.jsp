...
<div class="container">
    <div class="p-5 mb-4">
        ...
        <p class="fs-4">Este es un proyecto CRUD (Create, Read, Update, Delete) con fines educativos para el programa "Codo a Codo", realizado por el <a target="_blank" href="https://github.com/flavia-Arroyo"> Arroyo Flavia</a>.</p>
